...
const BorrowManager = () => {
  ...
  const handlePickupConfirm = async () => {
    ...
    try {
      ...
      // Gọi backend upload ảnh + xác nhận
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-slate-50 to-purple-50 py-8 px-4 md:px-8">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {/* ===== Modal xác nhận lấy sách với preview ảnh ===== */}
        <Modal
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              {previewStudent && (
                <img
                  src={previewStudent}
                  alt="Học sinh"
                  style={{ marginTop: 10, maxHeight: 120, borderRadius: 4 }}
                />
              )}
            </div>
            ...
            <div>
              <Upload
                ...
                showUploadList={false}
              >
                <Button icon={<UploadOutlined />}>Upload ảnh thẻ</Button>
              </Upload>
              {previewCard && (
                <img
                  src={previewCard}
